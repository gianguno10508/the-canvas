...
function Footer(props) {
    ...
    return (
        <footer className={`footer ${bgDark}`}>
                ...
                <div className="footer-widgets-wrap row col-mb-50">
                    ...
                    <div className="col-lg-2 col-sm-6">
                        <div className="widget widget_links">
                            ...
                            <div className="mt-3">
                                <a href="https://facebook.com/" className="social-icon si-small si-dark si-facebook" title="Facebook" target="_blank">
                                    <i className="fa-brands fa-facebook-f"></i>
                                </a>
                                <a href="https://instagram.com/" className="social-icon si-small si-dark si-instagram" title="instagram" target="_blank">
                                    <i className="fa-brands fa-instagram"></i>
                                </a>
                                <a href="https://twitter.com/" className="social-icon si-small si-dark si-twitter" title="twitter" target="_blank">
                                    <i className="fa-brands fa-twitter"></i>
                                </a>
                                <a href="#" className="social-icon si-small si-dark si-wikipedia" title="Apple Pay">
            ...
            <div id={`copyright`} className={`${bgLessDark}`}>
                <div className="container">
                    <div className="col-left row align-items-center justify-content-between col-mb-30">
                        ...
                        <div className="col-right col-lg-auto text-center text-lg-start">
            ...
            <div id="gotoTop" onClick={scrollToTop} style={{ display: visible ? 'inline' : 'none' }} className="icon-angle-up rounded-circle"></div>
        </footer>
    );
}
