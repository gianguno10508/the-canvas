                            ...
                            <div ref={refdrmenu} className={`justify-content-lg-center collapse navbar-collapse ${showMenu}`} id="navbarNav">
                                <ul className="navbar-nav">
                                    <li className="nav-item">
                                        <Link to='/' className={`nav-link current ${colorWhite}`} href="#"><div id="my-element">Home</div></Link>
                                    </li>
                                    <li className="nav-item">
                                    ...
                                    <li className="nav-item">
                                        <Link className={`nav-link ${colorWhite}`} to='/business'><div>Business</div></Link>
                                    </li>
                                    <li className="nav-item">
